/*
  1.7.27 - Cutover seed for atomicmarket_template_prices_updates
  (see database.sql for why this is a version of its own rather than one more
  statement in 1.7.26's transaction).
  ...
  enqueued between 1.7.26's COMMIT and this statement is fresher than the seed,
  ...
  is delayed by this version, and unlike the DDL in 1.7.26 it is paid while
