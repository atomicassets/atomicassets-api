/*
  2.0.6 - Incremental, queue-driven template-price recompute.
  (The schema, triggers and function body live in atomicmarket.sql; the cutover
  seed lives in 2.0.7. This file carries only the timeouts and the dbinfo bump.)
  ...
  leaves the seed to run under ACCESS SHARE alone in 2.0.7.
...
UPDATE dbinfo SET "value" = '2.0.6' WHERE name = 'version';
